...
func Aliyun(number string, code string) (_err error) {
	...
	sendSmsRequest := &dysmsapi20170525.SendSmsRequest{
		SignName:      tea.String("余隆鑫的图书管理系统"),
		TemplateCode:  tea.String("SMS_461430427"),
	...
	tryErr := func() (_e error) {
		...
		he, _err := client.SendSmsWithOptions(sendSmsRequest, runtime)
		log.Printf("he%+v\n", he)
		if _err != nil {
			return _err
		}
